            ...
            <?php
                $account_fields = [
                    [
                        ...
                        'label' => esc_html__( 'Nome', 'labo-suisse-theme' ) . '*',
                    ...
                    [
                        ...
                        'label' => esc_html__( 'Cognome', 'labo-suisse-theme' ) . '*',
                    ...
                    [
                        ...
                        'label' => esc_html__( 'Nome da visualizzare', 'labo-suisse-theme' ) . '*',
                        'hint' => esc_html__( 'Questo sarà il modo in cui il tuo nome verrà visualizzato nella sezione account e nelle recensioni', 'labo-suisse-theme' ),
                        'disabled' => false,
                        'required' => true,
                        'class' => 'input-text',
                        'variants' => ['tertiary'],
                    ...
                    [
                        ...
                        'label' => esc_html__( 'Indirizzo e-mail', 'labo-suisse-theme' ) . '*',
                        'autocomplete' => 'email',
                        'disabled' => false,
                        'required' => true,
                        'class' => 'input-text',
            ...
            <?php
                $password_fields = [
                    [
                        ...
                        'value' => '',
                        'label' => esc_html__( 'Password attuale (lascia vuoto per non modificare)', 'labo-suisse-theme' ) . '*',
                        'autocomplete' => 'off',
                        'disabled' => false,
                        'required' => false,
                        'class' => 'input-text',
                    ...
                    [
                        ...
                        'name' => 'password_1',
                        'value' => '',
                        'label' => esc_html__( 'Nuova password (lascia vuoto per non modificare)', 'labo-suisse-theme' ) . '*',
                        'autocomplete' => 'off',
                        'disabled' => false,
                        'required' => false,
                        'class' => 'input-text',
                    ...
                    [
                        ...
                        'name' => 'password_2',
                        'value' => '',
                        'label' => esc_html__( 'Conferma la nuova password', 'labo-suisse-theme' ) . '*',
                        'autocomplete' => 'off',
                        'disabled' => false,
                        'required' => false,
                        'class' => 'input-text',
