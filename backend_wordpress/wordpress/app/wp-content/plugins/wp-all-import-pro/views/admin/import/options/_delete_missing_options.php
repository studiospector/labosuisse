            ...
            <?php if ( !in_array('is_send_removed_to_trash', $hidden_delete_missing_options) ): ?>
                <div class="input">
                    ...
                    <?php if ( $post_type == 'product' ): ?>
                        <label for="is_send_removed_to_trash"><?php printf(__('Send removed %s to trash and disable removed variations', 'wp_all_import_plugin'), $cpt_name); ?></label>
                        <a href="#help" class="wpallimport-help" title="<?php _e('Removed parent products will have their variations moved to the trash with them. Removed variations will be disabled if their parent isn\'t sent to the trash.', 'wp_all_import_plugin') ?>" style="top: -1px;">?</a>
                    <?php else: ?>
