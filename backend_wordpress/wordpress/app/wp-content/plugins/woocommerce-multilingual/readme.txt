=== WooCommerce Multilingual & Multicurrency - run WooCommerce with WPML ===
...
Allows running fully multilingual & multicurrency e-commerce sites using WooCommerce and WPML.
