...
class CBR_PRO_Product {
	...
	*/
	function add_cbr_product_data_tab( $product_data_tabs ) {
		...
		$product_data_tabs[ 'cbr' ] = array(
			'label' => esc_html( 'Country Restrictions', 'country-base-restrictions-pro-addon' ), // translatable
	...
	*/
	function add_custom_product_fields() {
		...
		echo '<div class="options_group"><h4 style="padding-left: 12px;font-size: 14px;">Country Based Restrictions</h4>';
			...
			woocommerce_wp_select(
				array(
					...
					'label'   		=> esc_html( 'Restriction rule', 'country-base-restrictions-pro-addon' ),
					'default'       => 'all',
					'style'			=> 'max-width:350px;width:100%;',
					'class'         => 'availability cbr_restricted_type',
					'options'       => array(
						'all'       => esc_html( 'Product Available for all countries', 'country-base-restrictions-pro-addon' ),
						'specific'  => esc_html( 'Product Available for selected countries', 'country-base-restrictions-pro-addon' ),
						'excluded'  => esc_html( 'Product not Available for selected countries', 'country-base-restrictions-pro-addon' ),
					)
				)
			);
		...
		<p class="form-field forminp restricted_countries">
            <label for="_restricted_countries"><?php echo esc_html_e( 'Select countries', 'country-base-restrictions-pro-addon' ); ?></label>
	...
	*/
	function add_custom_variation_fields( $loop, $variation_data, $variation ) {
		...
		?>
		<p class="form-field forminp restricted_countries">
            <label for="_restricted_countries[<?php echo $variation->ID; ?>]"><?php echo __( 'Select countries', 'country-base-restrictions-pro-addon' ); ?></label>
