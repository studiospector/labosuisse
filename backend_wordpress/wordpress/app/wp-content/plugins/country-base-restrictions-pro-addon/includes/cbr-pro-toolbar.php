		...
		if ( is_admin_bar_showing() ) {
			...
			// if current user can edit_users than he can see this
				...
				$wp_admin_bar->add_menu(
					array(
						'id'    => 'cbr_item',
						'title' => esc_html( 'CBR Country: ' . WC()->countries->countries[ cbr_pro_addon()->restriction->get_country() ],'fast-user-switching' ),
						'href'  => '#',
					)
				);
			...
			<?php
			cbr_pro_widget::get_instance()->cbr_widget_popup_style();
			$html = ob_get_clean();
